...
// Reads the CSE source (CSE_Core_S3-S8_2024_COMPLETE_SYLLABUS.json) and the
// CS_AI source (CSE_AI_S3-S8_2024_COMPLETE_IMPORT.json) and regenerates
// lib/syllabusData.ts subject arrays + module topic data. Safe to run
// repeatedly: output is deterministic and duplicates are impossible
...
const D = (p) => join("C:", "Users", "Sreerang", "Downloads", ...p.split("/"));

const DEFAULT_CSE = D("CSE_Core_S3-S8_2024_COMPLETE_SYLLABUS.json");
const DEFAULT_AI = D("CSE_AI_S3-S8_2024_COMPLETE_IMPORT.json");
const DEFAULT_AI_ACC = D("TKM_CSE_CSE_AI_2024_COMPLETE_IMPORT_READY/CSE_AI_S3-S8_2024_ACCURATE_IMPORT.json");
...
// Source: CSE_Core_S3-S8_2024_COMPLETE_SYLLABUS.json +
//         CSE_AI_S3-S8_2024_COMPLETE_IMPORT.json (KTU 2024 scheme).
