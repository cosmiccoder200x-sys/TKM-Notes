...
import { programFromSlug, programSlug, masteryUrl } from "@/lib/urls";
...
export default function SubjectPage({
      ...
      {modules.length > 0 && (
        <section className="space-y-4">
          ...
          <div className="flex items-center justify-between gap-3 flex-wrap pt-2">
            ...
            <ModuleMasteryBadges subjectCode={subject.code} modules={modules} programId={programId} />
          </div>
  ...
  const masterySlot = (
    <div className="space-y-4">
      ...
      {modules.length > 0 && (
        <Link
          href={masteryUrl(programId, subject.semesterId, subject.slug)}
